...
<!--COLUMN 2-->
			<div class="col-xs-6 col-sm-7 col-md-3" id="columntwoswitch">
				<div class="text-center">
					<h4 id="totalhoursheader" class="dashboardheader">TOTAL HOURS<h4>
				</div>
	<!--TOTAL HOURS-->
				<div class="text-center totalhours">
					<h1 id="totalhours"><strong>94</strong></h1>
				</div>				
				<div class="text-right checkinlink">
					<h5 id="checkinlink"><a href="dashboard.php">Check In</a></h5>
				</div>
			</div>
			<!--END COLUMN TWO SWITCH-->
